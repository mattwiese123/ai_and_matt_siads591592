...
script_dir = os.path.dirname(__file__) # cwd relative path of script
...
dense_ret = pd.read_csv(os.path.join(script_dir, 'dense_return2020.csv'), index_col=0)
tickers = list(dense_ret.columns)
fig = px.line(dense_ret[['SPY']].cumsum())

# =========for correlation treemap===========
merged2 = pd.read_csv(os.path.join(script_dir, 'stock_covid_search_pct_change_corr_final.csv'), index_col=0)
...
timeline_df = pd.read_csv(os.path.join(script_dir, 'COVID_timeline.csv'))
...
covid_search = pd.read_csv(os.path.join(script_dir,'covid_search_trend.csv'), index_col=0)
...
news_count = pd.read_csv(os.path.join(script_dir,'NYTnews_keyword_monthly.csv'), index_col=0)
...
comps = pd.read_csv(os.path.join(script_dir,'sp500_comp_description.csv'), index_col=0)
